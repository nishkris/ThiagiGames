...
function initializeLayout() {
	...
	puzzleContainer.id = 'puzzleDiv';
	puzzleContainer.className = 'container1';
	...
	solutionContainer.className = 'container1';
	...
	for ( var count = 0; count < chunckPuzzle.length; count++) {
		var chunkLableDiv = document.createElement('div');
         chunkLableDiv.className = 'lableDivStyle';
         chunkLableDiv.id = 'puzzleLableDiv#' + count;
		...
		var chunkLabel = document.createElement('button');
		...
		puzzleContainer.appendChild(chunkLableDiv);
