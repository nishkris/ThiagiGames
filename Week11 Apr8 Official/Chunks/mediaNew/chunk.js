...
function initializeLayout() {
    ...
    var newWidth = chunck_size * chunkArray.length * .75 * findFontSizeProperty('.btn-primary0');
    var newHeight = findFontSizeProperty('.btn-primary0');
    var fraction = 0.0;
	...
	for ( var count = 0; count < chunckPuzzle.length; count++) {
        ...
        chunkLableSolDiv.style.height =  findFontSizeProperty('.btn-primary0')+'px';
		chunkLableSolDiv.style.width = (2*findFontSizeProperty('.btn-primary0'))+'px';
		var str="";
