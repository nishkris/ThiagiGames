...
function initializeLayout() {
    ...
    stateMap[solutionContainer.id] = document.getElementById('puzzleSolveDiv').innerHTML;
	...
	$(".lableDivStyle").droppable({
	    drop: function( event, ui ) {
	        ...
	        if((solutionMap[this.id]==undefined) && (document.getElementById(ui.draggable[0].id).innerHTML != solutionMap[this.id])){
                 ...
                 // stateMap[this.id] = document.getElementById(this.id).innerHTML;
	              }else{
	    ...
	    out: function (event, ui){
			   ...
			   // document.getElementById('puzzleSolveDiv').innerHTML = stateMap['puzzleSolveDiv'];
